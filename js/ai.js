...
function getBestMove(grid, runs, debug) {
		...
		for (var i=0;i<4;i++) {
			...
			if (score >= bestScore) {
				...
				besttotalmoves = res.total_moves;
			}
		...
		console.log('Move ' + moveName(bestMove) + ": Extra score - " + bestScore + " Avg number of moves: " + bestAvgMoves+ " Total Number of moves: " +besttotalmoves);
...
//	return min;
//	return avg+max;
	return {score: avg, avg_moves:avg_moves, total_moves:total_moves};
}
